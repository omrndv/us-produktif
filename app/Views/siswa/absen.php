        ...
        <form method="post" action="<?= site_url('/isi-absen'); ?>">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="nama" name="nama" value="<?= session()->get('nama'); ?>"
            ...
            <input type="hidden" id="kelas" name="kelas" value="<?= session()->get('kelas'); ?>">
            <input type="hidden" id="mapel" name="mapel" value="<?= $mapel ?>">
            <input type="hidden" name="id_dafjur" value="<?= session()->get('id_dafjur') ?>">
